- # CLAUDE.md
  ...
  **Implementation Requirements:**
  - [x] Record button toggles recording state
  - [x] Audio input captured to loop buffer
  - [x] Loop length determined by second button press
  - [x] Sample-accurate start/stop timing

  **Exit Tests (All Must Pass):**
  - [x] ✅ Can record a simple 1-bar loop and hear it play back
  - [x] ✅ LoopTime display updates correctly during recording
  - [x] ✅ Record LED shows red during recording, green when stopped
    (it blinks red- wrong, it is solid red.)
  - [x] ✅ Loop playback starts immediately after recording stops
  - [x] ✅ No audio artifacts or clicks at loop boundaries
  - [x] ✅ Can record loops from 0.1 seconds to 198 seconds
